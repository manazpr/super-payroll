...
class CreateStream extends Component {
    ...
    render() {
        return (
            <Container>
            <Modal classname="newModal" show={true} onHide={this.props.closeCreateModal}>
            <Modal.Header classname="newModal" closeButton onClick={this.props.closeCreateModal}>
            ...
            <Modal.Body>
                ...
                <Form>
                    <Form.Group className="mb-3">
                        <Form.Label htmlFor="address">Employee Address </Form.Label>
                        <Form.Control type="text" name="address" value={this.state.address} onChange={this.handleChange}></Form.Control>
                    </Form.Group>

                    <Form.Group className="mb-3">
                        <Form.Label htmlFor="amount">Salary/Month</Form.Label>
